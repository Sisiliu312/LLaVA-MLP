...
export PYTHONPATH=/home/data/shika/LLaVA-ly-ca
...
#     --bf16 True \
#     --output_dir ./checkpoints/cat/llava-v1.5-7b-pretrain \
#     --num_train_epochs 1 \
...
#  /home/data/shika/miniconda3/envs/llava/bin/deepspeed --master_port 29403 --include localhost:0,1,2,3 llava/train/train_mem.py \
#     --lora_enable True --lora_r 128 --lora_alpha 256 --mm_projector_lr 2e-5 \
#     --deepspeed ./scripts/zero3.json \
#     --model_name_or_path lmsys/vicuna-7b-v1.5 \
#     --version v1 \
#     --data_path /home/data/shika/LLaVA/playground/data/LLaVA-Tuning/llava_v1_5_mix67k.json \
#     --image_folder /home/data/shika/LLaVA/playground/data/LLaVA-Tuning/ \
#     --vision_tower openai/clip-vit-large-patch14-336 \
#     --pretrain_mm_mlp_adapter ./checkpoints/cat/llava-v1.5-7b-pretrain/mm_projector.bin \
#     --mm_projector_type mlp2x_gelu \
#     --mm_vision_select_layer -2 \
#     --mm_use_im_start_end False \
#     --mm_use_im_patch_token False \
...
#     --bf16 True \
#     --output_dir ./checkpoints/cat/llava-v1.5-7b-lora \
#     --num_train_epochs 1 \
